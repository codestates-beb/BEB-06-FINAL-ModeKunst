...
const abi20 = JSON.parse(
  fs
    .readFileSync(
      "/Users/imjinseon/Desktop/codestates/BEB-06-FINAL-ModeKunst/sever/contract/erc20/ICToken_sol_ICToken.abi"
    )
    .toString()
);
const byte20 = fs
  .readFileSync(
    "/Users/imjinseon/Desktop/codestates/BEB-06-FINAL-ModeKunst/sever/contract/erc20/ICToken_sol_ICToken.bin"
  )
  .toString();
const abi721 = JSON.parse(
  fs
    .readFileSync(
      "/Users/imjinseon/Desktop/codestates/BEB-06-FINAL-ModeKunst/sever/contract/erc721/NFTLootBox_sol_NFTLootBox.abi"
    )
    .toString()
);
const byte721 = fs
  .readFileSync(
    "/Users/imjinseon/Desktop/codestates/BEB-06-FINAL-ModeKunst/sever/contract/erc721/NFTLootBox_sol_NFTLootBox.bin"
  )
  .toString();
