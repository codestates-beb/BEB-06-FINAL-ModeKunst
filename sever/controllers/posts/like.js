                            ...
                            if(UserNickname === nickname ){
                                ...
                                if(total_price <= point_amount){
                                    ...
                                    try{
                                        ...
                                        await User.decrement({ point_amount: total_price }, { where: { nickname: nickname } });

                                        await Server.increment({ used_point : user_price }, { where: { address: address } });

                                        await User.increment({ point_amount: user_price }, { where: { nickname: UserNickname } });
