...
//서버 관리자 배너 추가
router.post('/banner',banner_upload.single('banner_image'),adminController.banner.post);
//서버 관리자 배너 수정(TODO)
router.put('/banner/:bannerId',banner_upload.single('banner_image'),adminController.banner.put);
//서버 관리자 배너 불러오기(TODO)
