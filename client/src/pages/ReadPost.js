...
김진영 — 오늘 오전 1:01
그렇게 말씀해주시다니 감사합니다 ㅠㅠ
많이 배웠습니다 감사합니다
김진영 — 오늘 오전 1:10
형준님 이거 CardPost.js 한번만 확인해주세요
...
fashion info 없는 게시물 수정시 에러

다른 아이디로 로그인 안됨 ( isNotLoggin )

마일리지 없을 때 좋아요 누르면 로그인 페이지로
방금 로직 수정하면서
에러 테스트 해보는데
지금
볼 수 있을까요>
